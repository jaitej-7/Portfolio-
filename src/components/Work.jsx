...
const workData = [
    {
        ...
        image: GridImg,
        title: "The Grid",
        description: "A comprehensive digital platform focusing on modular layout and structured content delivery for modern web experiences.",
    ...
    },
    {
        ...
        description: "A scalable, atomic design system ensuring consistency, accessibility, and rapid prototyping across product ecosystems.",
    ...
    },
    {
        ...
        image: GradArenaImg,
        title: "GradArena",
        description: "Connecting graduates with opportunities through an intuitive, user-centric platform designed for career growth.",
